Main.FileSelect = (function(){
	...
	var _bindDragEvent= function(){
		var delayTime = 100;
		var leftOffset= -4;
		var topOffset = -4+	Main.Global.topbar_height;
		var $self;
		var startTime = 0;
		var hasStart  = false;
		var boxTop	  = 0;
		...
		var __makeDragBox = function(){
			...
			$('<div class="draggable-dragging">移动【'+Main.Global.fileListSelectNum+'】个选项</div>').appendTo('body');
		};
	};
	...
	var _bindSelectEvent = function(){
		...
		var $selectDiv		= null;
		var mainOffsetTop	= 0;
		var offset_top  	= 35+Main.Global.topbar_height;;
